using AIWebChat_HF_AIFoundry.Web.Components;
using AIWebChat_HF_AIFoundry.Web.Services;
using AIWebChat_HF_AIFoundry.Web.Services.Ingestion;
...
builder.Services.AddSqliteCollection<string, IngestedChunk>("data-aiwebchat-hf-aifoundry-chunks", vectorStoreConnectionString);
builder.Services.AddSqliteCollection<string, IngestedDocument>("data-aiwebchat-hf-aifoundry-documents", vectorStoreConnectionString);
